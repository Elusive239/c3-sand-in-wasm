...
panic:                                            ; preds = %if.exit
  ...
  call void %38(ptr align 8 %indirectarg, ptr align 8 %indirectarg12, ptr align 8 %indirectarg13, i32 617), !dbg !51
  unreachable, !dbg !51
}
...
panic:                                            ; preds = %if.exit
  ...
  call void %24(ptr align 8 %indirectarg, ptr align 8 %indirectarg2, ptr align 8 %indirectarg3, i32 30), !dbg !65
  unreachable, !dbg !65
}
...
panic:                                            ; preds = %if.exit26
  store %"char[]" { ptr @.panic_msg, i64 17 }, ptr %indirectarg, align 8
  store %"char[]" { ptr @.file.2, i64 18 }, ptr %indirectarg31, align 8
  store %"char[]" { ptr @.func.4, i64 5 }, ptr %indirectarg32, align 8
  %72 = load ptr, ptr @std.core.builtin.panic, align 8
  call void %72(ptr align 8 %indirectarg, ptr align 8 %indirectarg31, ptr align 8 %indirectarg32, i32 58), !dbg !113
  unreachable, !dbg !113

panic37:                                          ; preds = %checkok
  store %"char[]" { ptr @.panic_msg, i64 17 }, ptr %indirectarg38, align 8
  store %"char[]" { ptr @.file.2, i64 18 }, ptr %indirectarg39, align 8
  store %"char[]" { ptr @.func.4, i64 5 }, ptr %indirectarg40, align 8
  %73 = load ptr, ptr @std.core.builtin.panic, align 8
  call void %73(ptr align 8 %indirectarg38, ptr align 8 %indirectarg39, ptr align 8 %indirectarg40, i32 59), !dbg !119
  unreachable, !dbg !119
}
...
!2 = !DIFile(filename: "math_quaternion.c3", directory: "C:/Program Files/c3c/lib/std/math")
...
!31 = !DILocation(line: 24, scope: !26)
!32 = !DILocalVariable(name: "q2", arg: 2, scope: !26, file: !2, line: 24, type: !3)
!33 = !DILocalVariable(name: "amount", arg: 3, scope: !26, file: !2, line: 24, type: !9)
!34 = !DILocation(line: 607, scope: !35, inlinedAt: !37)
!35 = distinct !DISubprogram(name: "lerp", linkageName: "lerp", scope: !36, file: !36, line: 607, scopeLine: 607, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!36 = !DIFile(filename: "math.c3", directory: "C:/Program Files/c3c/lib/std/math")
!37 = !DILocation(line: 713, scope: !38, inlinedAt: !31)
!38 = distinct !DISubprogram(name: "lerp", linkageName: "lerp", scope: !36, file: !36, line: 713, scopeLine: 713, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!39 = !DILocalVariable(name: "len", scope: !40, file: !2, line: 615, type: !10, align: 8)
!40 = distinct !DISubprogram(name: "normalize", linkageName: "normalize", scope: !36, file: !36, line: 613, scopeLine: 613, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24, retainedNodes: !29)
!41 = !DILocation(line: 615, scope: !40, inlinedAt: !42)
!42 = !DILocation(line: 711, scope: !43, inlinedAt: !31)
!43 = distinct !DISubprogram(name: "normalize", linkageName: "normalize", scope: !36, file: !36, line: 711, scopeLine: 711, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!44 = !DILocation(line: 708, scope: !45, inlinedAt: !46)
!45 = distinct !DISubprogram(name: "dot", linkageName: "dot", scope: !36, file: !36, line: 708, scopeLine: 708, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!46 = !DILocation(line: 709, scope: !47, inlinedAt: !41)
!47 = distinct !DISubprogram(name: "length", linkageName: "length", scope: !36, file: !36, line: 709, scopeLine: 709, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!48 = !DILocation(line: 693, scope: !49, inlinedAt: !44)
!49 = distinct !DISubprogram(name: "sum", linkageName: "sum", scope: !36, file: !36, line: 693, scopeLine: 693, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!50 = !DILocation(line: 616, scope: !40, inlinedAt: !42)
!51 = !DILocation(line: 617, scope: !40, inlinedAt: !42)
!52 = distinct !DISubprogram(name: "invert", linkageName: "std_math_quaternion$double$.Quaternion.invert", scope: !2, file: !2, line: 26, type: !53, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !29)
!53 = !DISubroutineType(types: !54)
!54 = !{!3, !3}
!55 = !DILocalVariable(name: "q", arg: 1, scope: !52, file: !2, line: 26, type: !3)
!56 = !DILocation(line: 26, scope: !52)
!57 = !DILocalVariable(name: "length_sq", scope: !52, file: !2, line: 28, type: !9, align: 8)
!58 = !DILocation(line: 28, scope: !52)
!59 = !DILocation(line: 708, scope: !60, inlinedAt: !58)
!60 = distinct !DISubprogram(name: "dot", linkageName: "dot", scope: !36, file: !36, line: 708, scopeLine: 708, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!61 = !DILocation(line: 693, scope: !62, inlinedAt: !59)
!62 = distinct !DISubprogram(name: "sum", linkageName: "sum", scope: !36, file: !36, line: 693, scopeLine: 693, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!63 = !DILocation(line: 29, scope: !52)
!64 = !DILocalVariable(name: "inv_length", scope: !52, file: !2, line: 30, type: !9, align: 8)
!65 = !DILocation(line: 30, scope: !52)
!66 = !DILocation(line: 31, scope: !52)
!67 = distinct !DISubprogram(name: "slerp", linkageName: "std_math_quaternion$double$.Quaternion.slerp", scope: !2, file: !2, line: 34, type: !27, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !29)
!68 = !DILocalVariable(name: "q1", arg: 1, scope: !67, file: !2, line: 34, type: !3)
!69 = !DILocation(line: 34, scope: !67)
!70 = !DILocalVariable(name: "q2", arg: 2, scope: !67, file: !2, line: 34, type: !3)
!71 = !DILocalVariable(name: "amount", arg: 3, scope: !67, file: !2, line: 34, type: !9)
!72 = !DILocalVariable(name: "result", scope: !67, file: !2, line: 36, type: !3, align: 32)
!73 = !DILocation(line: 36, scope: !67)
!74 = !DILocalVariable(name: "q2v", scope: !67, file: !2, line: 38, type: !15, align: 32)
!75 = !DILocation(line: 38, scope: !67)
!76 = !DILocalVariable(name: "cos_half_theta", scope: !67, file: !2, line: 39, type: !9, align: 8)
!77 = !DILocation(line: 39, scope: !67)
!78 = !DILocation(line: 708, scope: !79, inlinedAt: !77)
!79 = distinct !DISubprogram(name: "dot", linkageName: "dot", scope: !36, file: !36, line: 708, scopeLine: 708, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!80 = !DILocation(line: 693, scope: !81, inlinedAt: !78)
!81 = distinct !DISubprogram(name: "sum", linkageName: "sum", scope: !36, file: !36, line: 693, scopeLine: 693, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!82 = !DILocation(line: 41, scope: !67)
!83 = !DILocation(line: 43, scope: !84)
!84 = distinct !DILexicalBlock(scope: !67, file: !2, line: 42, column: 2)
!85 = !DILocation(line: 44, scope: !84)
!86 = !DILocation(line: 47, scope: !67)
!87 = !DILocalVariable(name: "q1v", scope: !67, file: !2, line: 49, type: !15, align: 32)
!88 = !DILocation(line: 49, scope: !67)
!89 = !DILocation(line: 50, scope: !67)
!90 = !DILocation(line: 607, scope: !91, inlinedAt: !92)
!91 = distinct !DISubprogram(name: "lerp", linkageName: "lerp", scope: !36, file: !36, line: 607, scopeLine: 607, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!92 = !DILocation(line: 713, scope: !93, inlinedAt: !89)
!93 = distinct !DISubprogram(name: "lerp", linkageName: "lerp", scope: !36, file: !36, line: 713, scopeLine: 713, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!94 = !DILocalVariable(name: "half_theta", scope: !67, file: !2, line: 52, type: !9, align: 8)
!95 = !DILocation(line: 52, scope: !67)
!96 = !DILocation(line: 25, scope: !97, inlinedAt: !99)
!97 = distinct !DISubprogram(name: "promote_int", linkageName: "promote_int", scope: !98, file: !98, line: 20, scopeLine: 20, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!98 = !DIFile(filename: "values.c3", directory: "C:/Program Files/c3c/lib/std/core")
!99 = !DILocation(line: 315, scope: !100, inlinedAt: !95)
!100 = distinct !DISubprogram(name: "cos", linkageName: "cos", scope: !36, file: !36, line: 315, scopeLine: 315, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!101 = !DILocalVariable(name: "sin_half_theta", scope: !67, file: !2, line: 53, type: !9, align: 8)
!102 = !DILocation(line: 53, scope: !67)
!103 = !DILocation(line: 25, scope: !104, inlinedAt: !105)
!104 = distinct !DISubprogram(name: "promote_int", linkageName: "promote_int", scope: !98, file: !98, line: 20, scopeLine: 20, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!105 = !DILocation(line: 537, scope: !106, inlinedAt: !102)
!106 = distinct !DISubprogram(name: "sqrt", linkageName: "sqrt", scope: !36, file: !36, line: 537, scopeLine: 537, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!107 = !DILocation(line: 132, scope: !108, inlinedAt: !109)
!108 = distinct !DISubprogram(name: "abs", linkageName: "abs", scope: !36, file: !36, line: 132, scopeLine: 132, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!109 = !DILocation(line: 54, scope: !67)
!110 = !DILocation(line: 56, scope: !111)
!111 = distinct !DILexicalBlock(scope: !67, file: !2, line: 55, column: 2)
!112 = !DILocalVariable(name: "ratio_a", scope: !67, file: !2, line: 58, type: !9, align: 8)
!113 = !DILocation(line: 58, scope: !67)
!114 = !DILocation(line: 25, scope: !115, inlinedAt: !116)
!115 = distinct !DISubprogram(name: "promote_int", linkageName: "promote_int", scope: !98, file: !98, line: 20, scopeLine: 20, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!116 = !DILocation(line: 522, scope: !117, inlinedAt: !113)
!117 = distinct !DISubprogram(name: "sin", linkageName: "sin", scope: !36, file: !36, line: 522, scopeLine: 522, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!118 = !DILocalVariable(name: "ratio_b", scope: !67, file: !2, line: 59, type: !9, align: 8)
!119 = !DILocation(line: 59, scope: !67)
!120 = !DILocation(line: 25, scope: !121, inlinedAt: !122)
!121 = distinct !DISubprogram(name: "promote_int", linkageName: "promote_int", scope: !98, file: !98, line: 20, scopeLine: 20, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!122 = !DILocation(line: 522, scope: !123, inlinedAt: !119)
!123 = distinct !DISubprogram(name: "sin", linkageName: "sin", scope: !36, file: !36, line: 522, scopeLine: 522, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !24)
!124 = !DILocation(line: 60, scope: !67)
!125 = distinct !DISubprogram(name: "mul", linkageName: "std_math_quaternion$double$.Quaternion.mul", scope: !2, file: !2, line: 63, type: !126, scopeLine: 63, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !29)
!126 = !DISubroutineType(types: !127)
!127 = !{!3, !3, !3}
!128 = !DILocalVariable(name: "a", arg: 1, scope: !125, file: !2, line: 63, type: !3)
!129 = !DILocation(line: 63, scope: !125)
!130 = !DILocalVariable(name: "b", arg: 2, scope: !125, file: !2, line: 63, type: !3)
!131 = !DILocation(line: 65, scope: !125)
!132 = !DILocation(line: 66, scope: !125)
!133 = !DILocation(line: 67, scope: !125)
!134 = !DILocation(line: 68, scope: !125)
