...
panic:                                            ; preds = %entry
  ...
  call void %4(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 9), !dbg !28
  unreachable, !dbg !28
}
...
if.then:                                          ; preds = %checkok
  ret i64 ptrtoint (ptr @"std.core.builtin.IteratorResult$NO_MORE_ELEMENT" to i64), !dbg !45
...
panic:                                            ; preds = %entry
  ...
  call void %27(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 14), !dbg !40
  unreachable, !dbg !40
...
panic7:                                           ; preds = %cond.phi
  ...
  call void @std.core.builtin.panicf(ptr align 8 %indirectarg9, ptr align 8 %indirectarg10, ptr align 8 %indirectarg11, i32 20, ptr align 8 %indirectarg13), !dbg !49
  unreachable, !dbg !49
}
...
if.then:                                          ; preds = %checkok
  ret i64 ptrtoint (ptr @"std.core.builtin.IteratorResult$NO_MORE_ELEMENT" to i64), !dbg !60
...
panic:                                            ; preds = %entry
  ...
  call void %24(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 25), !dbg !55
  unreachable, !dbg !55
...
panic7:                                           ; preds = %cond.phi
  ...
  store %"any[]" %"$$temp", ptr %indirectarg13, align 8
  call void @std.core.builtin.panicf(ptr align 8 %indirectarg9, ptr align 8 %indirectarg10, ptr align 8 %indirectarg11, i32 31, ptr align 8 %indirectarg13), !dbg !64
  unreachable, !dbg !64
}
...
panic:                                            ; preds = %entry
  ...
  call void %8(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 35), !dbg !72
  unreachable, !dbg !72
}
...
if.then:                                          ; preds = %cond.phi9
  ret i64 ptrtoint (ptr @"std.core.builtin.IteratorResult$NO_MORE_ELEMENT" to i64), !dbg !86
...
panic:                                            ; preds = %entry
  ...
  call void %28(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 40), !dbg !77
  unreachable, !dbg !77
...
panic13:                                          ; preds = %if.exit
  ...
  call void @std.core.builtin.panicf(ptr align 8 %indirectarg15, ptr align 8 %indirectarg16, ptr align 8 %indirectarg17, i32 47, ptr align 8 %indirectarg19), !dbg !88
  unreachable, !dbg !88
}
...
!7 = !DIFile(filename: "string_iterator.c3", directory: "C:/Program Files/c3c/lib/std/core")
...
!36 = !DIDerivedType(tag: DW_TAG_typedef, name: "Char32", scope: !7, file: !7, line: 8, baseType: !37, align: 4)
