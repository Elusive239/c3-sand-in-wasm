...
@.str = private unnamed_addr constant [41 x i8] c"99c350fc43d6d41a711cb96d2ba501e883ac8341\00", align 1
@std.core.env.COMPILER_BUILD_HASH = weak_odr local_unnamed_addr constant %"char[]" { ptr @.str, i64 40 }, comdat, align 8, !dbg !0
@.str.42 = private unnamed_addr constant [11 x i8] c"2025-01-01\00", align 1
@std.core.env.COMPILER_BUILD_DATE = weak_odr local_unnamed_addr constant %"char[]" { ptr @.str.42, i64 10 }, comdat, align 8, !dbg !12
@std.core.env.OS_TYPE = weak_odr local_unnamed_addr constant i32 15, comdat, align 4, !dbg !14
@std.core.env.ARCH_TYPE = weak_odr local_unnamed_addr constant i32 32, comdat, align 4, !dbg !55
@std.core.env.ARCH_32_BIT = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !110
@std.core.env.ARCH_64_BIT = weak_odr local_unnamed_addr constant i8 1, comdat, align 1, !dbg !113
@std.core.env.LIBC = weak_odr local_unnamed_addr constant i8 1, comdat, align 1, !dbg !115
@std.core.env.NO_LIBC = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !117
@std.core.env.COMPILER_OPT_LEVEL = weak_odr local_unnamed_addr constant i32 0, comdat, align 4, !dbg !119
@std.core.env.BIG_ENDIAN = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !127
@std.core.env.I128_NATIVE_SUPPORT = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !129
@std.core.env.F16_SUPPORT = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !131
@std.core.env.F128_SUPPORT = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !133
@std.core.env.REGISTER_SIZE = weak_odr local_unnamed_addr constant i32 64, comdat, align 4, !dbg !135
@std.core.env.COMPILER_SAFE_MODE = weak_odr local_unnamed_addr constant i8 1, comdat, align 1, !dbg !137
@std.core.env.DEBUG_SYMBOLS = weak_odr local_unnamed_addr constant i8 1, comdat, align 1, !dbg !139
@std.core.env.BACKTRACE = weak_odr local_unnamed_addr constant i8 1, comdat, align 1, !dbg !141
@std.core.env.LLVM_VERSION = weak_odr local_unnamed_addr constant i64 19, comdat, align 8, !dbg !143
@std.core.env.BENCHMARKING = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !145
@std.core.env.TESTING = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !147
@std.core.env.MEMORY_ENV = weak_odr local_unnamed_addr constant i32 0, comdat, align 4, !dbg !149
@std.core.env.TRACK_MEMORY = weak_odr local_unnamed_addr constant i8 1, comdat, align 1, !dbg !157
@std.core.env.X86_64 = weak_odr local_unnamed_addr constant i8 1, comdat, align 1, !dbg !159
@std.core.env.X86 = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !161
@std.core.env.AARCH64 = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !163
@std.core.env.NATIVE_STACKTRACE = weak_odr local_unnamed_addr constant i8 1, comdat, align 1, !dbg !165
@std.core.env.LINUX = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !167
@std.core.env.DARWIN = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !169
@std.core.env.WIN32 = weak_odr local_unnamed_addr constant i8 1, comdat, align 1, !dbg !171
@std.core.env.POSIX = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !173
@std.core.env.OPENBSD = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !175
@std.core.env.FREEBSD = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !177
@std.core.env.NETBSD = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !179
@std.core.env.BSD_FAMILY = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !181
@std.core.env.WASI = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !183
@std.core.env.WASM_NOLIBC = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !185
@std.core.env.ADDRESS_SANITIZER = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !187
@std.core.env.MEMORY_SANITIZER = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !189
@std.core.env.THREAD_SANITIZER = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !191
@std.core.env.ANY_SANITIZER = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !193
@std.core.env.BUILTIN_EXPECT_IS_DISABLED = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !195
@std.core.env.BUILTIN_PREFETCH_IS_DISABLED = weak_odr local_unnamed_addr constant i8 0, comdat, align 1, !dbg !197
...
!2 = !DIFile(filename: "env.c3", directory: "C:/Program Files/c3c/lib/std/core")
...
!199 = !{i32 1, !"CodeView", i32 1}
!200 = !{i32 2, !"Debug Info Version", i32 3}
!201 = !{i32 2, !"wchar_size", i32 2}
!202 = !{i32 4, !"PIC Level", i32 2}
!203 = !{i32 1, !"uwtable", i32 2}
!204 = !{i32 1, !"MaxTLSAlign", i32 65536}
