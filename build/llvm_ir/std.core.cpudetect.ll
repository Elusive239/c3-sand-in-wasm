...
panic:                                            ; preds = %entry
  ...
  call void @std.core.builtin.panicf(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 146, ptr align 8 %indirectarg3), !dbg !157
  unreachable, !dbg !157
...
panic5:                                           ; preds = %if.then
  ...
  call void @std.core.builtin.panicf(ptr align 8 %indirectarg7, ptr align 8 %indirectarg8, ptr align 8 %indirectarg9, i32 146, ptr align 8 %indirectarg12), !dbg !157
  unreachable, !dbg !157
}
...
!2 = !DIFile(filename: "cpu_detect.c3", directory: "C:/Program Files/c3c/lib/std/core/private")
