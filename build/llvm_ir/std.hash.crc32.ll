...
checkok:                                          ; preds = %entry
  ...
  %5 = load i32, ptr %seed, align 4, !dbg !27
  %bnot = xor i32 %5, -1, !dbg !27
  store i32 %bnot, ptr %4, align 4, !dbg !27
  ret void, !dbg !27
...
panic:                                            ; preds = %entry
  ...
  call void %6(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 11), !dbg !25
  unreachable, !dbg !25
}
...
checkok:                                          ; preds = %entry
  ...
  %lshr = lshr i32 %6, 8, !dbg !36
  %7 = freeze i32 %lshr, !dbg !36
  %8 = load ptr, ptr %self, align 8, !dbg !36
  %9 = load i32, ptr %8, align 4, !dbg !36
  %10 = load i8, ptr %c, align 1, !dbg !36
  %zext = zext i8 %10 to i32, !dbg !36
  %xor = xor i32 %9, %zext, !dbg !36
  %and = and i32 %xor, 255, !dbg !36
  %zext3 = zext i32 %and to i64, !dbg !36
  %ge = icmp uge i64 %zext3, 256, !dbg !36
  %11 = call i1 @llvm.expect.i1(i1 %ge, i1 false), !dbg !36
  br i1 %11, label %panic4, label %checkok10, !dbg !36

checkok10:                                        ; preds = %checkok
  %ptroffset = getelementptr inbounds [4 x i8], ptr @std.hash.crc32.CRC32_TABLE, i64 %zext3, !dbg !36
  %12 = load i32, ptr %ptroffset, align 4, !dbg !36
  %xor11 = xor i32 %7, %12, !dbg !36
  store i32 %xor11, ptr %4, align 4, !dbg !36
  ret void, !dbg !36
...
panic:                                            ; preds = %entry
  ...
  call void %13(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 16), !dbg !34
  unreachable, !dbg !34
...
panic4:                                           ; preds = %checkok
  ...
  call void @std.core.builtin.panicf(ptr align 8 %indirectarg6, ptr align 8 %indirectarg7, ptr align 8 %indirectarg8, i32 18, ptr align 8 %indirectarg9), !dbg !36
  unreachable, !dbg !36
}
...
checkok12:                                        ; preds = %loop.body
  ...
  %14 = load i32, ptr %result, align 4, !dbg !59
  %lshr = lshr i32 %14, 8, !dbg !59
  %15 = freeze i32 %lshr, !dbg !59
  %16 = load i32, ptr %result, align 4, !dbg !59
  %17 = load i8, ptr %x, align 1, !dbg !59
  %zext = zext i8 %17 to i32, !dbg !59
  %xor = xor i32 %16, %zext, !dbg !59
  %and = and i32 %xor, 255, !dbg !59
  %zext14 = zext i32 %and to i64, !dbg !59
  %ge15 = icmp uge i64 %zext14, 256, !dbg !59
  %18 = call i1 @llvm.expect.i1(i1 %ge15, i1 false), !dbg !59
  br i1 %18, label %panic16, label %checkok26, !dbg !59

checkok26:                                        ; preds = %checkok12
  %ptroffset = getelementptr inbounds [4 x i8], ptr @std.hash.crc32.CRC32_TABLE, i64 %zext14, !dbg !59
  %19 = load i32, ptr %ptroffset, align 4, !dbg !59
  %xor27 = xor i32 %15, %19, !dbg !59
  store i32 %xor27, ptr %result, align 4, !dbg !59
  %20 = load i64, ptr %.anon3, align 8, !dbg !55
...
loop.exit:                                        ; preds = %loop.cond
  ...
  %22 = load i32, ptr %result, align 4, !dbg !61
  store i32 %22, ptr %21, align 4, !dbg !61
  ret void, !dbg !61
...
panic:                                            ; preds = %entry
  ...
  call void %23(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 21), !dbg !49
  unreachable, !dbg !49
...
panic16:                                          ; preds = %checkok12
  ...
  store %any %32, ptr %ptradd23, align 16
  %33 = insertvalue %"any[]" undef, ptr %varargslots22, 0
  %"$$temp24" = insertvalue %"any[]" %33, i64 2, 1
...
; Function Attrs: nounwind ssp uwtable
define weak_odr i32 @std.hash.crc32.encode(ptr align 8 %0) #0 comdat !dbg !69 {
entry:
  %result = alloca i32, align 4
  %.anon = alloca i64, align 8
...
checkok:                                          ; preds = %loop.body
  ...
  %9 = load i32, ptr %result, align 4, !dbg !82
  %lshr = lshr i32 %9, 8, !dbg !82
  %10 = freeze i32 %lshr, !dbg !82
  %11 = load i32, ptr %result, align 4, !dbg !82
  %12 = load i8, ptr %x, align 1, !dbg !82
  %zext = zext i8 %12 to i32, !dbg !82
  %xor = xor i32 %11, %zext, !dbg !82
  %and = and i32 %xor, 255, !dbg !82
  %zext9 = zext i32 %and to i64, !dbg !82
  %ge10 = icmp uge i64 %zext9, 256, !dbg !82
  %13 = call i1 @llvm.expect.i1(i1 %ge10, i1 false), !dbg !82
  br i1 %13, label %panic11, label %checkok21, !dbg !82

checkok21:                                        ; preds = %checkok
  %ptroffset = getelementptr inbounds [4 x i8], ptr @std.hash.crc32.CRC32_TABLE, i64 %zext9, !dbg !82
  %14 = load i32, ptr %ptroffset, align 4, !dbg !82
  %xor22 = xor i32 %10, %14, !dbg !82
  store i32 %xor22, ptr %result, align 4, !dbg !82
  %15 = load i64, ptr %.anon1, align 8, !dbg !78
  %addnuw = add nuw i64 %15, 1, !dbg !78
  store i64 %addnuw, ptr %.anon1, align 8, !dbg !78
  br label %loop.cond, !dbg !78

loop.exit:                                        ; preds = %loop.cond
  %16 = load i32, ptr %result, align 4, !dbg !84
  %bnot = xor i32 %16, -1, !dbg !84
  ret i32 %bnot, !dbg !84
...
!2 = !DIFile(filename: "crc32.c3", directory: "C:/Program Files/c3c/lib/std/hash")
...
!53 = !DILocalVariable(name: ".temp", scope: !54, file: !2, line: 24, type: !45, align: 8)
...
!69 = distinct !DISubprogram(name: "encode", linkageName: "std.hash.crc32.encode", scope: !2, file: !2, line: 36, type: !70, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !13, retainedNodes: !22)
...
!76 = !DILocalVariable(name: ".temp", scope: !77, file: !2, line: 39, type: !45, align: 8)
