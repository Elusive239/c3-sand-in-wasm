...
; Function Attrs: nounwind ssp uwtable
define weak_odr i64 @std.net.os.NativeSocket.set_non_blocking(ptr %0, i8 zeroext %1) #0 comdat !dbg !125 {
entry:
  ...
  store i8 %1, ptr %non_blocking, align 1
    #dbg_declare(ptr %non_blocking, !135, !DIExpression(), !134)
  %2 = load i8, ptr %non_blocking, align 1, !dbg !136
  %3 = trunc i8 %2 to i1, !dbg !136
  %zext = zext i1 %3 to i32, !dbg !136
  store i32 %zext, ptr %taddr, align 4
  %4 = load ptr, ptr %self, align 8
  %5 = call i32 @ioctlsocket(ptr %4, i32 -2147195266, ptr %taddr), !dbg !136
  %i2b = icmp ne i32 %5, 0, !dbg !136
  br i1 %i2b, label %if.then, label %if.exit, !dbg !136

if.then:                                          ; preds = %entry
  %6 = call i64 @std.net.os.socket_error(), !dbg !137
  ret i64 %6, !dbg !137
...
; Function Attrs: nounwind ssp uwtable
define weak_odr i64 @std.net.os.convert_error(i32 %0) #0 comdat !dbg !139 {
entry:
  %error = alloca i32, align 4
  %switch = alloca i32, align 4
  store i32 %0, ptr %error, align 4
    #dbg_declare(ptr %error, !143, !DIExpression(), !144)
...
switch.case:                                      ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$SOCKETS_NOT_INITIALIZED" to i64), !dbg !145

switch.case1:                                     ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$NETWORK_UNREACHABLE" to i64), !dbg !148

switch.case2:                                     ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$BAD_SOCKET_DESCRIPTOR" to i64), !dbg !150

switch.case3:                                     ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.io.IoError$NO_PERMISSION" to i64), !dbg !152

switch.case4:                                     ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$STILL_PROCESSING_CALLBACK" to i64), !dbg !154

switch.case5:                                     ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$ADDRESS_IN_USE" to i64), !dbg !156

switch.case6:                                     ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$CONNECTION_ALREADY_IN_PROGRESS" to i64), !dbg !158

switch.case7:                                     ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$BAD_SOCKET_DESCRIPTOR" to i64), !dbg !160

switch.case8:                                     ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.io.IoError$INTERRUPTED" to i64), !dbg !162

switch.case9:                                     ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.io.IoError$WOULD_BLOCK" to i64), !dbg !164

switch.case10:                                    ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$CONNECTION_REFUSED" to i64), !dbg !166

switch.case11:                                    ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$ALREADY_CONNECTED" to i64), !dbg !168

switch.case12:                                    ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$NETWORK_UNREACHABLE" to i64), !dbg !170

switch.case13:                                    ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$NOT_A_SOCKET" to i64), !dbg !172

switch.case14:                                    ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$OPERATION_NOT_SUPPORTED_ON_SOCKET" to i64), !dbg !174

switch.case15:                                    ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$CONNECTION_TIMED_OUT" to i64), !dbg !176

switch.case16:                                    ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.net.NetError$CONNECTION_RESET" to i64), !dbg !178

switch.default:                                   ; preds = %switch.entry
  ret i64 ptrtoint (ptr @"std.io.IoError$GENERAL_ERROR" to i64), !dbg !180
}

; Function Attrs: nounwind ssp uwtable
define weak_odr i64 @std.net.os.socket_error() #0 comdat !dbg !182 {
entry:
  %0 = call i32 @WSAGetLastError(), !dbg !185
...
!2 = !DIFile(filename: "common.c3", directory: "C:/Program Files/c3c/lib/std/net/os")
...
!42 = !DIFile(filename: "win32.c3", directory: "C:/Program Files/c3c/lib/std/net/os")
...
!117 = !{i32 1, !"CodeView", i32 1}
!118 = !{i32 2, !"Debug Info Version", i32 3}
!119 = !{i32 2, !"wchar_size", i32 2}
!120 = !{i32 4, !"PIC Level", i32 2}
!121 = !{i32 1, !"uwtable", i32 2}
!122 = !{i32 1, !"MaxTLSAlign", i32 65536}
!123 = distinct !DICompileUnit(language: DW_LANG_C11, file: !2, producer: "c3c", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !124, splitDebugInlining: false)
!124 = !{!0, !4, !8, !10, !12, !14, !16, !19, !21, !23, !26, !28, !30, !32, !34, !36, !38, !40, !43, !45, !47, !49, !51, !53, !55, !57, !59, !61, !63, !65, !67, !69, !71, !73, !75, !77, !79, !81, !83, !85, !87, !89, !91, !93, !95, !99, !101, !103, !105, !107, !109, !111, !113, !115}
!125 = distinct !DISubprogram(name: "set_non_blocking", linkageName: "std.net.os.NativeSocket.set_non_blocking", scope: !42, file: !42, line: 30, type: !126, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !123, retainedNodes: !132)
!126 = !DISubroutineType(types: !127)
!127 = !{!128, !130, !131, !3}
!128 = !DIDerivedType(tag: DW_TAG_typedef, name: "anyfault", baseType: !129)
!129 = !DIBasicType(name: "long", size: 64, encoding: DW_ATE_signed)
!130 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "void*", baseType: null, size: 64, align: 64, dwarfAddressSpace: 0)
!131 = !DIDerivedType(tag: DW_TAG_typedef, name: "NativeSocket", scope: !42, file: !42, line: 15, baseType: !130, align: 8)
!132 = !{}
!133 = !DILocalVariable(name: "self", arg: 1, scope: !125, file: !42, line: 30, type: !131)
!134 = !DILocation(line: 30, scope: !125)
!135 = !DILocalVariable(name: "non_blocking", arg: 2, scope: !125, file: !42, line: 30, type: !3)
!136 = !DILocation(line: 32, scope: !125)
!137 = !DILocation(line: 34, scope: !138)
!138 = distinct !DILexicalBlock(scope: !125, file: !42, line: 33, column: 2)
!139 = distinct !DISubprogram(name: "convert_error", linkageName: "std.net.os.convert_error", scope: !42, file: !42, line: 64, type: !140, scopeLine: 64, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !123, retainedNodes: !132)
!140 = !DISubroutineType(types: !141)
!141 = !{!128, !142}
!142 = !DIDerivedType(tag: DW_TAG_typedef, name: "WSAError", scope: !42, file: !42, line: 5, baseType: !7, align: 4)
!143 = !DILocalVariable(name: "error", arg: 1, scope: !139, file: !42, line: 64, type: !142)
!144 = !DILocation(line: 64, scope: !139)
!145 = !DILocation(line: 68, scope: !146)
!146 = distinct !DILexicalBlock(scope: !147, file: !42, line: 68, column: 29)
!147 = distinct !DILexicalBlock(scope: !139, file: !42, line: 66, column: 2)
!148 = !DILocation(line: 69, scope: !149)
!149 = distinct !DILexicalBlock(scope: !147, file: !42, line: 69, column: 23)
!150 = !DILocation(line: 70, scope: !151)
!151 = distinct !DILexicalBlock(scope: !147, file: !42, line: 70, column: 29)
!152 = !DILocation(line: 71, scope: !153)
!153 = distinct !DILexicalBlock(scope: !147, file: !42, line: 71, column: 22)
!154 = !DILocation(line: 72, scope: !155)
!155 = distinct !DILexicalBlock(scope: !147, file: !42, line: 72, column: 26)
!156 = !DILocation(line: 73, scope: !157)
!157 = distinct !DILexicalBlock(scope: !147, file: !42, line: 73, column: 25)
!158 = !DILocation(line: 74, scope: !159)
!159 = distinct !DILexicalBlock(scope: !147, file: !42, line: 74, column: 23)
!160 = !DILocation(line: 75, scope: !161)
!161 = distinct !DILexicalBlock(scope: !147, file: !42, line: 75, column: 20)
!162 = !DILocation(line: 76, scope: !163)
!163 = distinct !DILexicalBlock(scope: !147, file: !42, line: 76, column: 20)
!164 = !DILocation(line: 77, scope: !165)
!165 = distinct !DILexicalBlock(scope: !147, file: !42, line: 77, column: 26)
!166 = !DILocation(line: 78, scope: !167)
!167 = distinct !DILexicalBlock(scope: !147, file: !42, line: 78, column: 27)
!168 = !DILocation(line: 79, scope: !169)
!169 = distinct !DILexicalBlock(scope: !147, file: !42, line: 79, column: 22)
!170 = !DILocation(line: 80, scope: !171)
!171 = distinct !DILexicalBlock(scope: !147, file: !42, line: 80, column: 26)
!172 = !DILocation(line: 81, scope: !173)
!173 = distinct !DILexicalBlock(scope: !147, file: !42, line: 81, column: 23)
!174 = !DILocation(line: 82, scope: !175)
!175 = distinct !DILexicalBlock(scope: !147, file: !42, line: 82, column: 25)
!176 = !DILocation(line: 83, scope: !177)
!177 = distinct !DILexicalBlock(scope: !147, file: !42, line: 83, column: 24)
!178 = !DILocation(line: 84, scope: !179)
!179 = distinct !DILexicalBlock(scope: !147, file: !42, line: 84, column: 25)
!180 = !DILocation(line: 85, scope: !181)
!181 = distinct !DILexicalBlock(scope: !147, file: !42, line: 85, column: 12)
!182 = distinct !DISubprogram(name: "socket_error", linkageName: "std.net.os.socket_error", scope: !42, file: !42, line: 89, type: !183, scopeLine: 89, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !123)
!183 = !DISubroutineType(types: !184)
!184 = !{!128}
!185 = !DILocation(line: 91, scope: !182)
